...
(function ($) {
    ...
    $(document).ready(function () {
       ...
       function initializeSwiper(sliderContainer) {
            ...
            // For Development Debugging Only (Remove or disable in Production)
        ...
        if($('.brand-slider11').length > 0) {
        const brandSlider11 = new Swiper(".brand-slider11", {
            spaceBetween: 30,
            speed: 1300,
            loop: true,
            autoplay: {
      ...
      /*--------------------------------------------------
          16. Image Change On Selecting Accordiion Item
      ---------------------------------------------------*/
